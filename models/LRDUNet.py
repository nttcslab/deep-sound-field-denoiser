...
class UpBlock(nn.Module):
    ...
    def __init__(self, in_channels, cat_channels, out_channels, groups=16):
        ...
        self.conv_t = nn.ConvTranspose2d(
            in_channels, in_channels, 2, stride=2, groups=groups
        )
...
class DenoisingBlock(nn.Module):
    ...
    def __init__(
        self, in_channels, inner_channels, out_channels, inner_convolutions=1, groups=16
    ):
        ...
        for i in range(1, inner_convolutions + 1):
            dense_convolution = nn.Sequential(
                OrderedDict(
                    [
                        (
                            "conv",
                            nn.Conv2d(
                                in_channels + i * inner_channels,
                                inner_channels,
                                kernel_size=3,
                                padding=1,
                                groups=groups,
...
class LRDUNet(nn.Module):
    ...
    def __init__(self, **kwargs):
            ...
            OrderedDict(
                [
                    (
                        "encode 2 0",
                        DenoisingBlock(
                            filters_2, filters_2 // 2, filters_2, dense_convolutions
                        ),
                    ),
                    (
                        "encode 2 1",
            ...
            OrderedDict(
                [
                    (
                        "bottleneck 0",
                        DenoisingBlock(
                            filters_3, filters_3 // 2, filters_3, dense_convolutions
                        ),
                    ),
                    (
                        "bottleneck 1",
        ...
        self.output_block = OutputBlock(filters_0, in_channels)
